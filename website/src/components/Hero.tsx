        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          <div className="flex-1 text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <a
                href="#setup"
                className="px-8 py-3 bg-apple-gray-800 dark:bg-white text-white dark:text-apple-gray-800 rounded-lg font-medium hover:bg-apple-gray-700 dark:hover:bg-apple-gray-100 transition-colors"
              >
                Get Started
              </a>
              <a
            ...
            <div className="mt-10 flex flex-wrap gap-6 justify-center lg:justify-start text-sm text-apple-gray-400 dark:text-apple-gray-500">
